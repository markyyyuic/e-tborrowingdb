...
@students.get("/student/", response_model=list)
...
@students.get("/student/{Student_ID}", response_model=dict)
async def read_student(
    Student_ID: int, 
    db=Depends(get_db)
):
...
@students.post("/student/", response_model=dict)
...
@students.put("/student/{Student_ID}", response_model=dict)
...
@students.delete("/categories/{category_id}", response_model=dict)
